 ...
 *    even before the resource bundling is wired through Xcode.
 *
 * TODO iOS: bundle per-flavor config.json (dev/stage/prod) via Compose Resources or
 * Xcode build phase, mirroring Android's ConfigHelper -> assets/config/config.json
 * pipeline.
 */
