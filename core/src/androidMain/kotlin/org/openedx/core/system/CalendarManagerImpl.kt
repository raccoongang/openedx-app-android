...
class CalendarManagerImpl(
    ...
    override fun requestPermissions(launcher: Any) {
        (launcher as? androidx.activity.result.ActivityResultLauncher<Array<String>>)
            ?.launch(permissions)
    }

    override fun hasPermissions(): Boolean = permissions.all {
    ...
    override fun getGoogleCalendars(): List<UserCalendar> {
    ...
    override fun hasAlternativeCalendarApp(): Boolean {
