...
abstract class BaseDownloadViewModel(
    private val downloadModelsSource: DownloadModelsSource,
    ...
    init {
        viewModelScope.launch {
            downloadModelsSource.getDownloadModelsFlow()
    ...
    suspend fun getDownloadModelList(): List<DownloadModel> {
        return downloadModelsSource.getDownloadModelsFlow().first()
    }
