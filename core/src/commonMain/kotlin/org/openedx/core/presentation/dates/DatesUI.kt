...
import org.openedx.core.domain.model.color
import org.openedx.core.domain.model.stringRes
import org.openedx.core.ui.theme.appColors
import org.openedx.core.ui.theme.appTypography
import kotlinx.datetime.Clock
import org.openedx.core.utils.formatToString
...
@kotlin.jvm.JvmName("CourseDateBlockSectionCourseDates")
@Composable
fun CourseDateBlockSection(
    sectionKey: DatesSection = DatesSection.NONE,
    useRelativeDates: Boolean,
...
@kotlin.jvm.JvmName("DateBlockCourseDate")
@Composable
private fun DateBlock(
...
private fun CourseDateItem(
    ...
    Column(
        ...
        if (!dateBlock.dueDate.isToday() || dateBlock.dueDate < Clock.System.now()) {
            val timeTitle = formatToString(dateBlock.dueDate, useRelativeDates)
            Text(
                text = timeTitle,
                style = MaterialTheme.appTypography.labelMedium,
                color = MaterialTheme.appColors.textDark,
        ...
        Row(
            ...
            Icon(
                modifier = Modifier
                    .padding(end = 4.dp)
                    .align(Alignment.CenterVertically),
                painter = painterResource(Res.drawable.core_ic_assignment),
                contentDescription = null,
                tint = MaterialTheme.appColors.textDark
            )
            Text(
