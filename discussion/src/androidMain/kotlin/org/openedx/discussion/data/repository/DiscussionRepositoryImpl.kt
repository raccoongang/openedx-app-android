...
import org.openedx.discussion.discussion_unnamed_subcategory
...
class DiscussionRepositoryImpl(
    ...
    override suspend fun getCourseTopics(courseId: String): List<Topic> {
        val topicsData = api.getCourseTopics(courseId).mapToDomain()
        val defaultTopicName = resourceManager.getString(Res.string.discussion_unnamed_subcategory)
    ...
    override fun getCachedTopics(courseId: String) =
        if (courseId == currentCourseId) topics.toList() else emptyList()

    override suspend fun getCourseThreads(
        courseId: String,
        following: Boolean?,
        topicId: String?,
        orderBy: String,
    ...
    override suspend fun getCourseThread(
        threadId: String,
        courseId: String,
        topicId: String
    ...
    override suspend fun getThreadQuestionComments(
        threadId: String,
        endorsed: Boolean,
        page: Int
    ): CommentsData {
