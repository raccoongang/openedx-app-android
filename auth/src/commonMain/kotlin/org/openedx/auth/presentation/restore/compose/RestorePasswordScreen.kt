package org.openedx.auth.presentation.restore.compose
            ...
            Box(
                ...
                Text(
                    modifier = Modifier
                        ...
                        .fillMaxWidth(),
                    text = stringResource(authRes.string.auth_forgot_your_password),
                    color = Color.White,
                            ...
                            Column(
                                ...
                                Text(
                                    modifier = Modifier
                                        ...
                                        .fillMaxWidth(),
                                    text = stringResource(authRes.string.auth_please_enter_your_log_in),
                                ...
                                LoginTextField(
                                    modifier = Modifier.fillMaxWidth(),
                                    title = stringResource(authRes.string.auth_email),
                                    description = stringResource(authRes.string.auth_example_email),
                                    onValueChanged = {
                                        email = it
                                        isEmailError = false
                                    },
                                    ...
                                    errorMessages = stringResource(authRes.string.auth_error_empty_email)
                                )
                                ...
                                if (uiState == RestorePasswordUIState.Loading) {
                                    ...
                                    OpenEdXButton(
                                        ...
                                        text = stringResource(authRes.string.auth_reset_password),
                                        onClick = {
                                            keyboardController?.hide()
                                            if (email.isNotEmpty()) {
                                                onRestoreButtonClick(email)
                        ...
                        is RestorePasswordUIState.Success -> {
                            Column(
                                ...
                                Icon(
                                    ...
                                    painter = painterResource(authRes.drawable.auth_ic_email),
                                    contentDescription = null,
                                ...
                                Text(
                                    modifier = Modifier
                                        .fillMaxWidth(),
                                    textAlign = TextAlign.Center,
                                    text = stringResource(authRes.string.auth_check_your_email),
                                ...
                                Text(
                                    ...
                                    textAlign = TextAlign.Center,
                                    text = stringResource(
                                        authRes.string.auth_restore_password_success,
                                        uiState.email
                                    ),
                                ...
                                OpenEdXButton(
                                    ...
                                    text = stringResource(coreRes.string.core_sign_in),
                                    onClick = {
                                        onBackClick()
                                    }
                                )
